...
const AdminLayout = ({ children }) => {
    ...
    const navItems = [
        ...
        { name: 'Customer Approvals', path: '/admin/approvals', icon: '✅' },
        { name: 'Customers', path: '/admin/customers', icon: '👥' },
        { name: 'Vendor Management', path: '/admin/vendors', icon: '🏢' },
        { name: 'Allocations', path: '/admin/allocations', icon: '⚡' },
        { name: 'Support Requests', path: '/admin/tickets', icon: '🎧' },
    ...
    return (
        <div className="admin-layout" style={{ display: 'flex', minHeight: '100vh', background: '#f4f7f6', fontFamily: 'Inter, sans-serif' }}>
            ...
            <aside className="sidebar" style={{
                width: '280px',
                background: 'linear-gradient(180deg, #0F172A 0%, #022c22 100%)', // Deep slate to deep teal
                color: '#fff',
                display: 'flex',
                ...
                <div className="sidebar-header" style={{
                    ...
                    <div>
                        ...
                        <span style={{ display: 'block', fontSize: '0.65rem', fontWeight: '700', letterSpacing: '0.15em', color: '#5eead4', textTransform: 'uppercase', marginTop: '2px' }}>Admin Portal</span>
                    </div>
                </div>

                <nav className="sidebar-nav" style={{ flex: 1, padding: '16px 16px' }}>
                ...
                <div className="sidebar-footer" style={{ padding: '32px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                    <div style={{ marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                        <div style={{ width: '36px', height: '36px', background: '#334155', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.8rem', fontWeight: 'bold' }}>
                        ...
                        <div style={{ overflow: 'hidden' }}>
                            ...
                            <div style={{ fontSize: '0.7rem', color: '#94a3b8' }}>Admin Access</div>
                        </div>
                    </div>
                    <button
                    ...
                    <div style={{ marginTop: '16px', textAlign: 'center' }}>
                        <span style={{ fontSize: '0.65rem', color: '#475569', letterSpacing: '0.05em' }}>KDIA Ver 1.2.0</span>
                    </div>
                </div>
            </aside>
            ...
            <main style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
                <header style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <span style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: '500' }}>Service Administration</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        <div style={{ padding: '8px 16px', background: '#f1f5f9', borderRadius: '999px', fontSize: '0.75rem', fontWeight: '600', color: '#475569', display: 'flex', alignItems: 'center', gap: '8px' }}>
