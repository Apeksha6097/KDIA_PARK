...
const AdminLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!loginId.toLowerCase().includes('admin') && loginId !== 'admin') {
                // allow loose entry but maybe warn? No, strict instructions: "Treat any non-empty login attempt as successful"
                // actually, user said "Treat any non-empty login attempt as successful" in previous turn,
                // but updated instructions say "Bypass API calls... on button click... navigate".
                // I will allow ANY input to succeed as Admin if they are on Admin Login page.
            }
