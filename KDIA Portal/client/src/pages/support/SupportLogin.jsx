                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    ...
                    <div className="flex items-center justify-between text-sm px-1">
                        <label className="flex items-center gap-2 text-neutral-500 cursor-pointer select-none">
                            <input type="checkbox" className="w-4 h-4 rounded border-neutral-300 text-emerald-600 focus:ring-emerald-500 cursor-pointer" />
                            Remember Me
                        </label>
                        <a href="#" className="text-emerald-600 font-bold hover:underline">Forgot Access?</a>
                    </div>
