...
router.get('/summary', authenticateToken, async (req, res) => {
    ...
    try {
        ...
        const calcData = {
            investmentAmount: 0,
            energyAllocated: subscription ? subscription.totalUnits : 0,
            tariffRate: 0,
            projectDuration: 0
        };
        ...
        // Pass through the centralized calculation service
        ...
        const summary = {
            ...
            remainingUnits: subscription ? (allocatedUnits - totalConsumed) : 0,
