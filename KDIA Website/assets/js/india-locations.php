...
const indiaLocations = {
    ...
    "Gujarat": ["Ahmedabad", "Amreli", "Anand", "Aravalli", "Banaskantha", "Bharuch", "Bhavnagar", "Dahod", "Devbhumi Dwarka", "Gandhinagar", "Gir Somnath", "Jamnagar", "Junagadh", "Kheda", "Kutch", "Mahisagar", "Mehsana", "Morbi", "Narmada", "Navsari", "Panchmahal", "Patan", "Porbandar", "Rajkot", "Sabarkantha", "Surat", "Surendranagar", "Tapi", "Dangs", "Vadodara", "Valsad", "Botad", "Chhota Udaipur"],
    ...
    "West Bengal": ["Alipurduar", "Bankura", "Birbhum", "Coch Behar", "Dakshin Dinajpur", "Darjeeling", "Hooghly", "Howrah", "Jalpaiguri", "Jhargram", "Kalimpong", "Kolkata", "Malda", "Murshidabad", "Nadia", "North 24 Parganas", "Paschim Bardhaman", "Paschim Medinipur", "Purba Bardhaman", "Purba Medinipur", "Purulia", "South 24 Parganas", "Uttar Dinajpur"],
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (stateSelect && districtSelect) {
        ...
        stateSelect.addEventListener('change', function() {
            ...
            if (selectedState && indiaLocations[selectedState]) {
                districtSelect.disabled = false;
                const districts = indiaLocations[selectedState].sort();
