                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                {todayFocus.map((item, idx) => (
                                    <div key={idx} className={`p-6 rounded-2xl border ${item.border} ${item.bg} flex flex-col justify-between group/item hover:scale-[1.02] transition-transform`}>
                                        ...
                                        <button
                                            onClick={item.action}
                                            className={`w-full py-2.5 rounded-xl border border-white bg-white/50 text-[10px] font-black uppercase tracking-tight hover:bg-white transition-all ${item.color}`}
                                        >
                                            {item.label} Tasks
                                        </button>
                                    </div>
